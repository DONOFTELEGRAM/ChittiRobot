...
async def repo(_, message):
    users = await get(
        "https://api.github.com/repos/YashBebe/RajniiRobot/"
    )
    list_of_users = ""
    count = 1
    for user in users:
    ...
    text = f"""[Updates](https://t.me/RajniUpdates) | [Support](https://t.me/RajniSupportChat) | [SR Network](https://t.me/ShajniNetworks)
```----------------
| Contributors |
----------------```
{list_of_users}"""

...
__help__ = f"""Markdown is a very powerful formatting tool supported by telegram. @RajniiRobot has some enhancements, to make sure that 
...
and tapping on it will open the page at given url in (). (Without space between [] & ())

• Inline Button:
[This is a button] (buttonurl:example.com). (Without space between [] & ())
If you want multiple buttons on the same line, use ‘:same’ at second button,

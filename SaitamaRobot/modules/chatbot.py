...
def add_chat(update: Update, context: CallbackContext):
    ...
    if not is_kuki:
        ...
        msg.reply_text("Rajni AI successfully enabled for this chat!")
        message = (
        ...
        return message
    msg.reply_text("Rajni AI is already enabled for this chat!")
    return ""
...
def rem_chat(update: Update, context: CallbackContext):
    ...
    is_kuki = sql.is_kuki(chat.id)
    if not is_kuki:
        msg.reply_text("Rajni AI isn't enabled here in the first place!")
        return ""
    sql.rem_kuki(chat.id)
    msg.reply_text("Rajni AI disabled successfully!")
    message = (
        f"<b>{html.escape(chat.title)}:</b>\n"
        f"AI_DISABLED\n"
        f"<b>Admin:</b> {mention_html(user.id, html.escape(user.first_name))}\n"
...
def chatbot(update: Update, context: CallbackContext):
    ...
    if message.text and not message.document:
        ...
        kukiurl = requests.get('https://www.kuki-api.tk/Kuki/chatbot?message='+Message)
...
*Commands:* 
*Admins only:*
`addchat`*:* Enables AI Chatbot mode in the chat.
`rmchat`*:* Disables AI Chatbot mode in the chat.
   
*Reports bugs at @RajniSupportChat*
"""

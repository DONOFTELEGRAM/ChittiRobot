...
async def lego(event):
 ...
 try:
    ...
    fname2 = "RajniiRobotLogo.png"
    img.save(fname2, "png")
    await tbot.send_file(event.chat_id, fname2, caption="Made By @RajniiRobot")
    if os.path.exists(fname2):
            os.remove(fname2)
 except Exception as e:
   await event.reply(f'Error Report @RajniSupport, {e}')
...
async def lego(event):
 ...
 try:
   ...
   await event.reply(f'Error Report @RajniSupport,\n`{e}`')
